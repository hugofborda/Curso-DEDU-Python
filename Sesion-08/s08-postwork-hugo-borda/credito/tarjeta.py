...
class Tarjeta_de_credito:
    ...
    def get_deuda_recalculada(self):
        return self.__deuda_recalculada
    ...
    def calcula_nueva_deuda(self):
        """
        Función que calcula el nivel de deuda para el proximo mes pública
        """   
